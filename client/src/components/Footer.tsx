    ...
    <footer id="about" className="bg-[#1A237E] text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="mb-4 text-gray-200">
              Trang thông tin lịch sử Việt Nam từ thời Vua Hùng dựng nước đến
              thời hiện đại, giúp bạn khám phá hành trình 4000 năm dựng nước và
              giữ nước của dân tộc.
            </p>
            <div className="flex space-x-4 mt-6">
              <a
                href="#"
                className="text-white hover:text-[#FF8A80] transition-colors duration-300 bg-white/10 p-2 rounded-full"
              >
                <Facebook size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <p className="mb-4 text-gray-200">
              Đăng ký để nhận thông tin mới nhất về lịch sử Việt Nam.
            </p>
            <div className="mt-4">
        ...
        <div className="border-t border-indigo-900 mt-10 pt-6 text-center text-sm text-indigo-200 flex flex-col md:flex-row justify-between items-center">
          <p>
            &copy; {new Date().getFullYear()} Lịch Sử Việt Nam. Xây dựng bởi{" "}
            <a href="https://tathanhan.com" target="_blank">
              {" "}
              Tạ Thanh An Group
            </a>
            .
