          ...
          <div className="horizontal-timeline-container" ref={horizontalTimelineRef}>
            ...
            <div className="horizontal-timeline-wrapper">
              ...
              <div className="timeline-info">
                ...
                <p>Hành trình lịch sử hàng nghìn năm của dân tộc Việt Nam qua các giai đoạn phát triển.</p>
                <a href="#">Tìm hiểu thêm &gt;</a>
              </div>
              
              {/* Timeline với event cards */}
              <ol className="horizontal-timeline">
                {events.slice(0, 12).map((event, index) => (
                  <li key={event.id} className="horizontal-event-card">
                    <div className="horizontal-event-content">
                      <time className="horizontal-event-year">{event.year}</time>
                ...
                <li></li> {/* Required for proper layout */}
              </ol>
            </div>
          </div>
        )}
